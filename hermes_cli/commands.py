...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("swarm", "Show legal multi-agent task activity and worker logs",
               "Tools & Skills", args_hint="[status|logs|follow] [task-id]",
               subcommands=("status", "logs", "log", "follow", "help")),
