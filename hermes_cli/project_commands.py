...
2. **先读 Term Sheet。** 通读 TS 全文，提取所有关键商业条款为清单。
3. **逐条在合同中定位。** 按 TS 清单逐条在目标合同中查找对应条款。
