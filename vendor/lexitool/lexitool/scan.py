...
def scan_text(
    ...
    *,
    ...
    """Scan body paragraphs and table cells for query/regex matches."""
    if not query:
    ...
    return {
        ...
        "results": results,
        "next_step": (
            "For legal revision, read every paragraph_targets range with lex_read "
            "before editing; after editing, run lex_scan again in view='final' "
            "to confirm total_matches is zero or intentionally retained."
        ),
    }
