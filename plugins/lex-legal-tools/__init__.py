...
- project management (project_create, project_list, project_select, etc.)
...
_TOOL_MODULES = [
    ...
    "tools.lex_translation_review_tool",
    "tools.lexitool_tool",
    # Legal workflow
    "tools.legal_evidence_gate",
    "tools.legal_ocr_guard",
    "tools.legal_orchestration_tool",
    "tools.legal_profile_tool",
    "tools.legal_workflow_learning",
    "tools.legal_workflow_tool",
    # Project management
    "tools.project_management_tool",
    # Kanban swarm
