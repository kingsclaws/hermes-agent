...
_HERMES_CORE_TOOLS = [
    ...
    *_LEXITOOL_TOOLS,
    ...
    "project_create", "project_register", "project_init_start", "project_source_digest",
...
TOOLSETS = {
    ...
    "lex-docx-coordinator": {
        ...
        "tools": [
            ...
            "edit_verification_record", "lex_proofread", "lex_template_audit",
            "lex_translation_review", "lex_review_workflow", "lex_verify_edits",
            "legal_harness_migrate", "legal_harness_workflow", "legal_handoff_record", "legal_scorecard",
    ...
    "lex-docx-worker": {
        ...
        "tools": [
            ...
            "lex_convention_profile", "legal_review_plan",
            "edit_verification_record", "lex_proofread", "lex_template_audit",
            "lex_template_fill", "lex_translation_review", "lex_review_workflow",
            "lex_verify_edits", "legal_harness_migrate", "legal_harness_workflow",
            "legal_handoff_record", "legal_scorecard",
