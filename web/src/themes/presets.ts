...
export const nousTheme: DashboardTheme = {
  name: "nous",
  label: "Nous",
  description: "Desktop nous — glass neutrals with Nous blue accents",
  palette: {
    background: { hex: "#0c0c0e", alpha: 1 },
    midground: { hex: "#0053FD", alpha: 1 },
    foreground: { hex: "#ffffff", alpha: 0.08 },
    warmGlow: "rgba(0, 83, 253, 0.18)",
    noiseOpacity: 1,
  },
  typography: {
    ...DEFAULT_TYPOGRAPHY,
    fontSans: `"Segoe UI", -apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", ${SYSTEM_SANS}`,
