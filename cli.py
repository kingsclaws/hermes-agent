...
def _build_compact_banner() -> str:
    ...
    if skin_name == "default":
        line1 = "⚖ LEX AGENT - Legal AI Agent"
        tiny_line = "⚖ LEX AGENT"
    else:
        agent_name = _skin.get_branding("agent_name", "Lex Agent") if _skin else "Lex Agent"
    ...
    if os.environ.get("HERMES_FAST_STARTUP_BANNER") == "1":
        ...
        version_line = f"Lex Agent v{_version} ({_release_date})"
    else:
...
class HermesCLI:
    ...
    def run(self):
        ...
        def handle_ctrl_z(event):
            ...
            from prompt_toolkit.application import run_in_terminal
            from hermes_cli.skin_engine import get_active_skin
            agent_name = get_active_skin().get_branding("agent_name", "Lex Agent")
