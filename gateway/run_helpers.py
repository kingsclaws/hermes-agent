"""Helper functions extracted from gateway.run for code organization.

This module re-exports all module-level utility functions back into
gateway.run via ``from gateway.run_helpers import *`` for backward
compatibility. Mixin files access these through
``import gateway.run as _gw; _gw._function_name()``.
"""
...
# ---------------------------------------------------------------------------
# Regex constants used by the extraction functions
# ---------------------------------------------------------------------------
